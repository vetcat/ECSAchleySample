...
namespace anygames.ashley.utils
{
	...
	public class SnapshotArray<T> : Array<T>
	{
		...
		public SnapshotArray (bool ordered, int capacity, Type arrayType) : base(ordered, capacity, arrayType)
		{

		}

		public SnapshotArray (bool ordered, int capacity) : base (ordered, capacity)
		{
		...
		//static public T SnapshotArray<T> (Array array)
		//{
